...
const switchVariants = cva(
  "group/switch inline-flex cursor-pointer shrink-0 items-center rounded-full border transition-colors outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] data-[checked]:border-toggle-on/30 data-[checked]:bg-toggle-on data-[unchecked]:border-border data-[unchecked]:bg-muted/80 disabled:cursor-not-allowed disabled:opacity-50",
  {
    variants: {
      size: {
